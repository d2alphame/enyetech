		...
		return ( 
			<nav aria-label="Page navigation example">
  				<ul className="pagination">
    				<li className="page-item" onClick={this.props.firstPageHandler}><a className="page-link" href="#">First</a></li>
    				...
    				<li className="page-item" onClick={this.props.lastPageHandler}><a className="page-link" href="#">Last</a></li>
  				</ul>
			</nav>
		 );
	}
